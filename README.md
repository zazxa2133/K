 ...
 Mouse.Button1Down:connect(
   ...
   function Create(base, team, Misc)
      ...
      if team and game.Players.localPlayer.Team == Misc.Team then
         ...
         txtlbl.TextColor3 = Color3.new(0,0,155)
...
game:GetService("Players").LocalPlayer.Idled:connect(function()
   vu:addButton2Down(Vector2.new(0,0),workspace.CurrentCamera.CFrame)
   wait(1)
   vu:addButton2Up(Vector2.new(0,0),workspace.CurrentCamera.CFrame)
end)
